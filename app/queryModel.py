...
#Model: "Query_model_ngram.pt"
#Tokenizer: "tokenizer_Query_model_ngram.pickle"
...
class AttentionModelQuery(nn.Module):
    def __init__(self,seq_len,embd_dim,num_vocab):
        super(AttentionModelQuery,self).__init__()
...
def infer_query(s, tok, model):
    flag_ = {0:'Query', 1:'Complain',2:'Appreciation', 3:'Feedback', 4:'Spam'}
