...
#Model: "PI_model.pt"
#Tokenizer: "tokenizer_pi_attention.pickle"
#number of Vocab: 2000
#sentence Length: 100
#Embedding Dim: 100
#--------------------Model Config END---------------
...
class AttentionModelPI(nn.Module):
    def __init__(self,seq_len,embd_dim,num_vocab):
        super(AttentionModelPI,self).__init__()
        self.seq_len = seq_len
        self.embd_dim = embd_dim
        self.num_vocab = num_vocab
        self.lstm = nn.LSTM(self.embd_dim,50,2,batch_first=True,bidirectional=True)
        self.embd = nn.Embedding(num_vocab,embd_dim,padding_idx=0)
        self.transformer = nn.TransformerEncoderLayer(embd_dim,nhead=10)
...
def clean_dataset(texts: list, max_sq_len=100, tok=None, ngram=True, num_voc=2000):
    clean_texts = []
